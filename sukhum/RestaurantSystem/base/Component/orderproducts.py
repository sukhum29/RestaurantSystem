...
class OrderedProducts(tk.Frame):
    ...
    def populate_menu(self):
        ...
        for r in res:
            ...
            order_status = r[4]
            self.tr_view.insert('', tk.END, values=(product_name, product_quantity, order_status))
    ...
    def store_cooked_orders(self):
        try:
            ...
            for item in self.tr_view.get_children():
                ...
                self.fac_db.insert_spec_config(spec_insert_query, (order_id, self.t_num, or_name, or_quantity, or_total))
        except Error as e:
            print(e)
