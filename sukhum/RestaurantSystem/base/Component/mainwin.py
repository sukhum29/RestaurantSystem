...
class MainWindow(tk.Tk):
    def __init__(self):
        ...
        self.iconphoto(True, tk.PhotoImage(file='C:/Users/win11/Desktop/sukhum/RestaurantManagementSystemV0.1.1/assets/icon_m.png'))
        ...
        self.img = Image.open("RestaurantManagementSystemV0.1.1/assets/main_win_ph.png")
