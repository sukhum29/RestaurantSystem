...
class PrintOrders(tk.Toplevel):
    def __init__(self, parent):
        ...
        self.tr_view = ttk.Treeview(self.cst_lbl, columns=self.tr_view_columns, show='headings', height=15, selectmode='browse', yscrollcommand=self.tr_v_vscr.set)
        ...
        self.tr_view.grid(column=0,row=3, rowspan=6, columnspan=3, pady=10, padx=10)
    ...
    def load_orders (self):
        try:
            ...
            if self.t_num:
                ...
                messagebox.showerror("Empty imput field", "Please fill in the table number to get orders!")
                self.print_receipt_btn.config(state=tk.DISABLED)
    ...
    def print_receipt(self):
        ...
        with open("RestaurantManagementSystemV0.1.1/order_template.html") as html_doc:
